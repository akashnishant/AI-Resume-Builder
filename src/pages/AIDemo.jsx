    ...
    <div className="min-h-screen bg-gray-950 text-white mt-20 content-page">
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-gray-950/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-300">
            ...
            <span>Live AI Demos – no sign‑up</span>
          </div>
          <div className="flex gap-2">
            <SecondaryButton onClick={() => window.history.back()}>
              <ArrowLeft className="h-4 w-4" /> Back
            </SecondaryButton>
            <Button onClick={() => alert("Route to /builder or your signup flow")}>Continue to Builder <ArrowRight className="h-4 w-4" /></Button>
          </div>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
          ...
          >
            Try the <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">AI Resume Builder</span> in your browser
          </motion.h1>
      ...
      <main className="mx-auto max-w-6xl px-4 pb-16">
        ...
        <div className="mx-auto mt-10 max-w-3xl rounded-2xl border border-white/10 bg-gray-900/70 p-6 text-center">
          ...
          <div className="mt-4 flex justify-center gap-2">
            <Button onClick={() => alert("Route to /builder")}>Start Free</Button>
