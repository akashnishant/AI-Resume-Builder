...
export default function AmazonTemplate2({ data = defaultResumeData }) {
  const d = data;
  return (
    <div className="border-2 border-orange-600 max-w-3xl mx-auto my-6">
      <Header data={d} color="bg-orange-600" />
      <div className="p-6">
        <p className="italic mb-4">{d.summary}</p>
