...
export default function MicrosoftTemplate2({ data = defaultResumeData }) {
  const d = data;
  return (
    <div className="border shadow-md max-w-3xl mx-auto my-6 bg-gray-50">
      <Header data={d} color="bg-blue-800" />
