...
export default function MetaTemplate2({ data = defaultResumeData }) {
  const d = data;
  return (
    <div className="border rounded-2xl shadow-lg max-w-3xl mx-auto my-6 bg-white">
      <Header data={d} color="bg-gradient-to-r from-blue-500 to-purple-600" />
      <div className="p-8">
        <p className="text-lg mb-6">{d.summary}</p>
