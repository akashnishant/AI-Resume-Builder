...
export default function AdobeTemplate2({ data = defaultResumeData}) {
  const d = data;
  return (
    <div className="border max-w-3xl mx-auto my-6 bg-gradient-to-br from-red-100 to-white resume-template-cotainer">
      <Header data={d} color="bg-red-700" />
      <div className="p-6 font-serif">
        <p className="mb-4 italic">{d.summary}</p>
